...
def generate_message():
    ...
    message = f'''🎉 Congratulations,\nहमें ये बताते हुए अत्यंत हर्ष हो रहा है कि _*{student_data.STUDENTS_NAME}*_ का प्रमोशन Class _*{student_data.previous_class}*_ से Class _*{student_data.promoted_class}*_ में सफलतापूर्वक हो चुका है!\n\n\t✨ नया रोल नंबर: _*{student_data.promoted_roll}*_\n\t📅 तारीख: _*{student_data.promoted_date}*_\n\n🙌 आपकी मेहनत ने रंग लाये! ऐसे ही आगे बढ़ते रहो, चमकते रहो और हम सबका नाम रोशन करते रहो! 🌟'''
            
    if student_data.due_amount:
        message += f'''\n\n 💰 शेष बकाया राशि: _*{student_data.due_amount}*_ रुपये, कृपया यथासंभव शीघ्र भुगतान करने की कृपा करें। 🙏'''
